...
(function() {
    ...
    const TAB_DEFINITIONS = {
        ...
        video: {
            ...
            svg: `<svg width="28" height="28" viewBox="0 0 28 28" fill="none" class="vkuiIcon vkuiIcon--28 vkuiIcon--video_outline_28"><path fill="currentColor" fill-rule="evenodd" d="M4.5 5.5a3 3 0 0 0-3 3v11a3 3 0 0 0 3 3h13a3 3 0 0 0 3-3v-2l4.35 2.61A1.5 1.5 0 0 0 27 18.82V9.18a1.5 1.5 0 0 0-2.15-1.29L20.5 10.5v-2a3 3 0 0 0-3-3h-13Zm14 4.5v8a1 1 0 0 1-1 1h-13a1 1 0 0 1-1-1v-11a1 1 0 0 1 1-1h13a1 1 0 0 1 1 1v2Zm2 4.19l4.5 2.7V9.61l-4.5 2.7v1.88Z" clip-rule="evenodd"/></svg>`
        },
        bookmarks: {
            label: 'Закладки',
            href: '/bookmarks',
